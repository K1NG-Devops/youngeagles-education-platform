...
import { FaBook, FaBell, FaUser, FaClipboardList, FaSpinner, FaChevronDown, FaChevronUp, FaCalendarAlt, FaEye, FaFileUpload, FaChalkboardTeacher } from 'react-icons/fa';
  ...
  const fetchTeacherData = useCallback(async () => {
    ...
    try {
      ...
      const homeworkRes = await axios.get(
        `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:3000'}/api/homeworks/for-teacher/${teacherId}`,
        {
          headers: {
      ...
      const submissionsRes = await axios.get(
        `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:3000'}/api/homeworks/teacher/all-submissions`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
