...
const TeacherLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // For development, simulate teacher login
      if (import.meta.env.DEV) {
        // Mock teacher login for development
        const mockTeacher = {
          id: 2,
        ...
        {import.meta.env.DEV && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-6">
            <p className="text-xs text-yellow-800 text-center">
              <strong>Development Mode:</strong> Enter any email/password to test teacher dashboard
            </p>
          </div>
        )}
